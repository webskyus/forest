...
$(function(){$(document).ready(function(){svg4everybody({})}),$(document).ready(function(){$("a,img").on("dragstart",function(t){t.preventDefault()})}),$(window).scroll(function(t){$(this).scrollTop()>$(this).height()?($(".to-top").addClass("visible"),$(".to-top").removeClass("hidden")):($(".to-top").removeClass("visible"),$(".to-top").addClass("hidden")),$(".to-top").click(function(t){$("html, body").stop().animate({scrollTop:0},"slow")})}),$(document).ready(function(){var t;$(".trigger").on("click",(t=1,function(){1===t?(t=2,$(".main-menu").css("top","0%"),$(this).toggleClass("trigger-active"),$(this).css("position","fixed"),$(this).css("right","4%")):2===t&&(t=1,$(".main-menu").css("top","100%"),$(this).toggleClass("trigger-active"),$(this).css("position","static"))}))}),$(".works-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!0,fade:!0})});